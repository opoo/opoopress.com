...
<section>
  ...
  <#--
  <script type="text/javascript" src="//${website.disqus_short_name}.disqus.com/recent_comments_widget.js?num_items=5&hide_avatars=1&avatar_size=32&excerpt_length=100"></script>
  -->
