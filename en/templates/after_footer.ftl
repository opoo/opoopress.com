<#--
<script type="text/javascript" src="${site.default_theme_root}/javascripts/libs/modernizr.min.js"></script>
<script type="text/javascript" src="${site.default_theme_root}/javascripts/libs/jquery.min.js"></script>
<script type="text/javascript" src="${site.default_theme_root}/javascripts/libs/swfobject-modified.min.js"></script>
<script type="text/javascript" src="${site.default_theme_root}/javascripts/libs/opoopress.js"></script>
-->
