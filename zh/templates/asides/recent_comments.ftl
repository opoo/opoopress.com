...
<section>
  ...
  <!--
	...
	var rcw_script_src = (is_https ? 'https:' : 'http:') + '//${site.disqus_short_name}.disqus.com/recent_comments_widget.js?num_items=10&excerpt_length=100&hide_avatars=' + (is_https ? '1' : '0&avatar_size=32');
