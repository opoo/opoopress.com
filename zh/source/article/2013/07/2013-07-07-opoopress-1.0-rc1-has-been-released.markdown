...
## 如何开始
这是一个 OpooPress 站点的实例 [Opoo.org](https://opoo.org)，可先看一下效果。

OpooPress 第一版已经发布，比较容易安装和部署，请在下载页下载，并查看[文档](/zh/docs/)了解细节。

<a class="download-button" href="/zh/download/">下载 OpooPress</a>
